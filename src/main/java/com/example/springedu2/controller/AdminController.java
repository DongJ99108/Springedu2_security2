...
public class AdminController {
    ...
    public String addCreate(
        ...
        try {
            ...
            return "memberAdminForm"; // 회원 추가 실패 -> 다시 추가 화면으로 이동
        }
    ...
    public String adminEditForm(
        ...
        // DB 에서 조회한 member -> memberAdminEditForm 에서 사용할 객체인 MemberUpdateForm 구조로 변경
    ...
    public String adminDelete(
            ...
            RedirectAttributes redirectAttributes // 1회성 메시지 전달할 수 있게 하는
    ) {
